...
interface Student {
  ...
  parent_contact: string; // Add this field
  profile: {
    avatar_url: string;
    email: string;
  };
...
export default function StudentsPage() {
  ...
  const handleEdit = (student: Student) => {
    ...
    setFormData({
      ...
      parent_contact: student.parent_contact, // Add this field
    });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const studentData = {
        ...
        parent_contact: formData.parent_contact, // Add this field
      };
      ...
      const { error } = editingStudent
        ...
        : await supabase
            .from('students')
            .insert([{ ...studentData, user_id: profile?.id }]);
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                <Avatar className="h-12 w-12">
                  ...
                  <AvatarFallback>{student.profile?.email[0]}</AvatarFallback>
                </Avatar>
                <div>
                  <h3 className="text-lg font-semibold">{student.profile?.email}</h3>
