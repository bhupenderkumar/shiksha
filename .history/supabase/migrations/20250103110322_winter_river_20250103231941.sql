...
VALUES
  ('user-id-1', 'student', 'John Doe', 'https://example.com/avatar1.png'),
  ('user-id-2', 'teacher', 'Jane Smith', 'https://example.com/avatar2.png'),
  ('user-id-3', 'admin', 'Admin User', 'https://example.com/avatar3.png');
...
-- Add this policy to allow authenticated users to insert new rows
CREATE POLICY "Enable insert for authenticated users"
  ON students FOR INSERT
  TO authenticated
  WITH CHECK (auth.uid() IS NOT NULL);

-- Add this policy to allow authenticated admin users to delete rows
...
-- Add this policy for assignments
