  ...
  return (
    <div className="calendar-container">
      <div className="calendar-header">
        <div className="weekdays flex justify-center space-x-4">
          <div className="weekday text-center w-9 sm:w-10">Sun</div>
          <div className="weekday text-center w-9 sm:w-10">Mon</div>
          <div className="weekday text-center w-9 sm:w-10">Tue</div>
          <div className="weekday text-center w-9 sm:w-10">Wed</div>
          <div className="weekday text-center w-9 sm:w-10">Thu</div>
          <div className="weekday text-center w-9 sm:w-10">Fri</div>
          <div className="weekday text-center w-9 sm:w-10">Sat</div>
        </div>
      </div>
